...
* The majority of my work and notes are in the Project_2_DerekTopper doc.
* Docker Compose is my docker compose file.
* The derek-topper history file is the history of my commands in terminal.
* The assessment-attempts file is the data used.
* The rest of this document is the assignment.
